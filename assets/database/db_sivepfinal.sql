...
--
-- Host: localhost:3306
-- Generation Time: Jul 19, 2019 at 08:14 AM
...
INSERT INTO `contacto` (`idcontacto`, `DNI_CONT`, `NOM_CONT`, `APP_CONT`, `APM_CONT`, `FENAC_CONT`, `TEL_CONT`, `EMAIL_CONT`, `OBS_CONT`) VALUES
(13, '12345678', 'VALERIO', 'LOAYZA', 'RIOS', '2002-01-06', 984491340, 'valerio123@hotmail.com', 'NADA'),
(16, '34456578', 'LUCILA', 'PORRAS', 'LUNA', '2000-03-12', 987656566, 'luci@hotmail.com', 'nada'),
(17, '34343566', 'JUANITO', 'LOPEZ', 'TABARA', '2000-03-12', 987876655, 'junito@hotmail.com', 'NADA'),
(18, '42586932', 'CESAR AURELIO', 'CERVANTES', '', '0000-00-00', 981865979, 'ccervantesflores@gmail.com', '');

-- --------------------------------------------------------

--
-- Stand-in structure for view `contactoval`
-- (See below for the actual view)
--
CREATE TABLE `contactoval` (
`idcontacto` int(11)
,`Nombres_y_Apellidos` varchar(302)
,`DNI_CONT` char(8)
,`FENAC_CONT` date
,`TEL_CONT` int(9)
,`EMAIL_CONT` varchar(100)
,`nroValuacion` varchar(20)
,`a104b` varchar(45)
,`cantidad` bigint(21)
,`costo` decimal(32,2)
,`pago` decimal(32,2)
,`OBS_CONT` varchar(200)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `contactovaluacion`
-- (See below for the actual view)
--
CREATE TABLE `contactovaluacion` (
`idcontacto` int(11)
,`Nombres_y_Apellidos` varchar(302)
,`DNI_CONT` char(8)
,`FENAC_CONT` date
...
(105, 115, 1, 'RESUMEN', '200---Buena---3', '0.00', 1),
(106, 115, 1, 'PRIMER', 'SALA, COCINA,BAÑOS', '100.00', 2),
(107, 115, 1, 'SEGUNDO', 'DORMITORIOS, BAÑOS', '100.00', 3),
(183, 131, 1, 'RESUMEN', '400---Buena---2', '0.00', 1),
(184, 131, 1, 'PRIMER', 'SALA, COCINA,BAÑOS,ALMACEN', '200.00', 2),
(185, 131, 1, 'SEGUNDO', 'DORMITORIOS,BAÑOS', '200.00', 3),
(186, 131, 2, 'RESUMEN', '200---undefined---2', '0.00', 4),
(187, 131, 2, 'PRIMER', 'ALMACEN', '100.00', 5),
(188, 131, 2, 'SEGUNDO', 'DORMITORIOS, SALA,COCINA,BAÑOS', '100.00', 6),
(189, 132, 1, 'RESUMEN', '100---Regular---5', '0.00', 1),
(190, 132, 1, 'PRIMER', 'SALA,COCINA,BAÑOS,DORMITORIOS', '100.00', 2),
(200, 160, 1, 'RESUMEN', '50---Seleccione...---0', '0.00', 1),
(201, 160, 1, 'PRIMER', 'Este es un dato', '50.00', 2),
(202, 160, 2, 'RESUMEN', '50---Buena---1', '0.00', 3),
(203, 160, 2, 'PRIMER', 'Este es otro dato', '50.00', 4),
(204, 161, 1, 'RESUMEN', '102---Buena---19', '0.00', 1),
(205, 161, 1, 'PRIMER NIVEL', 'SALA, COCINA, COMEDOR, DORMITORIO, SS.HH', '102.00', 2),
(206, 162, 1, 'RESUMEN', '52.52---Buena---0', '0.00', 1),
(207, 162, 1, 'SEGUNDO', '2 AMBIENTES DE CONSULTORIO, RECEPCION, SS.HH CAJA DE ESCALERAS', '52.52', 2);
...
CREATE TABLE `fabrica` (
  ...
  `muro` varchar(200) DEFAULT NULL,
  `techo` varchar(200) DEFAULT NULL,
  `puerta` varchar(200) DEFAULT NULL,
  `ventana` varchar(200) DEFAULT NULL,
  `revestimiento` varchar(200) DEFAULT NULL,
  `piso` varchar(200) DEFAULT NULL,
  `sshh` varchar(200) DEFAULT NULL,
  `sanitaria` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `fabrica` (`idfabrica`, `idvaluacion`, `sistema`, `muro`, `techo`, `puerta`, `ventana`, `revestimiento`, `piso`, `sshh`, `sanitaria`) VALUES
(27, 115, 'Adobe', 'Drywall,Madera', 'Termo acústico', 'Madera Contraplacada', 'Estructura de Madera', 'Enchapado con piedra', 'Cemento Pulido', 'Completo con cerámico importado', 'Agua caliente'),
(55, 131, 'Concreto Armado', 'Ladrillo de Arcilla,Muro de ladrillos de concreto', 'Termo acústico', 'Madera Contraplacada', 'Estructura de Madera', 'Enchapado con piedra', 'Cemento Pulido', 'Básico de granito', 'Agua caliente'),
(56, 131, 'Concreto Armado', 'Madera,Muro de ladrillos de concreto', 'Teja Andina', 'Madera Tablero Rajado', 'Vidrio Semi Doble,Estructura de Madera', 'Enchapado con piedra,Estucado con yeso', 'Tierra Compactada', '', 'Corriente monofásica'),
(57, 132, 'Concreto Armado', 'Madera', 'Fibrocemento', 'Madera Contraplacada', 'Madera fina ornamental', 'Enchapado con piedra', 'Sin Piso', 'Completo con mayólica nacional de color', 'Corriente monofásica'),
(61, 160, 'Adobe', 'Drywall', 'Termo acústico', 'Madera Tablero Rajado', 'Estructura de Madera', 'Mármol importado', 'Cerámico Nacional', 'Baños completos de lujo', 'Corriente trifásica'),
(62, 161, 'Concreto Armado', 'Muro de ladrillos de concreto', 'Losa o aligerado de concreto armado', 'Madera fina ornamental', 'Estructura de Aluminio', 'Tarraje frotachado', 'Cerámico Nacional', 'Completo con mayólica nacional de color', 'Corriente monofásica'),
(63, 162, 'Concreto Armado', 'Techos de losa aligerado horizontal', 'Aligerados o losas de concreto armado Horizontales', 'Aluminio o madera fina de diseño especial', 'Vidrio tratado transparente', 'Pintura lavable', 'Mármol nacional o reconstituido', 'Mayólica o cerámico decorativo nacional de color', 'Agua fría,Corriente monofásica,Teléfono,Ascensor');
...
(88, 115, 'assets/uploads/FB_IMG_1487563441943.jpg', 'FACHADA'),
(89, 115, 'assets/uploads/Screenshot_2017-03-07-16-15-44-1.png', 'COCINA'),
(90, 115, 'assets/uploads/IMG-20160828-WA0000.jpg', 'SALA'),
(91, 131, 'assets/uploads/ramengallina.jpg', 'COCINA'),
(92, 131, 'assets/uploads/tepuy 1.jpg', 'SALA'),
(93, 131, 'assets/uploads/WhatsApp Image 2019-03-14 at 2.15.09 PM (2).jpeg', 'SALA'),
(94, 131, 'assets/uploads/nanamicoct.jpg', 'DORMITORIO1'),
(95, 132, 'assets/uploads/RAMEN.jpeg', 'SALA'),
(96, 132, 'assets/uploads/Sushi-Bar.jpg', 'COCINA'),
(97, 132, 'assets/uploads/yakitori.jpg', 'COMEDOR'),
(109, 160, 'assets/uploads/54645645.jpg', 'Esta es la descripción de la foto que se muestra'),
(110, 160, 'assets/uploads/6735.jpg', 'Esta es la descripción de la foto que se muestra'),
(111, 160, 'assets/uploads/23432.jpg', 'Esta es la descripción de la foto que se muestra'),
(112, 160, 'assets/uploads/54654.jpg', 'Esta es la descripción de la foto que se muestra'),
(113, 160, 'assets/uploads/546456.jpg', 'Esta es la descripción de la foto que se muestra'),
(114, 160, 'assets/uploads/34745767.jpg', 'Esta es la descripción de la foto que se muestra'),
(115, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.07.28.jpeg', 'VISTA FRONTAL DEL PREDIO'),
(116, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.07.34.jpeg', 'VISTA LADO ESTE DEL PREDIO'),
(117, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.07.52.jpeg', 'VISTA FRONTAL DEL DEPARTAMENTO'),
(118, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.15.22.jpeg', 'SALA'),
(119, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.15.24.jpeg', 'COCINA'),
(120, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.15.34.jpeg', 'COCINA'),
(121, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.16.07.jpeg', 'DORMITORIO'),
(122, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.16.23.jpeg', 'SALA'),
(123, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.16.26.jpeg', 'DORMITORIO'),
(124, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.16.29.jpeg', 'DORMITORIO'),
(125, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.16.35.jpeg', 'SALA'),
(126, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.15.53.jpeg', 'SS.HH'),
(127, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.16.20.jpeg', 'SS.HH'),
(128, 161, 'assets/uploads/WhatsApp Image 2019-07-17 at 18.16.27.jpeg', 'SS.HH'),
(129, 162, '', '');
...
(185, 115, 'POR EL FRENTE', 'CON EL SR. JUAN QUISPE'),
(186, 115, 'POR EL FONDO', 'SRA. JUANA LOPEZ'),
(187, 115, 'POR LA DERECHA', 'CON LA IGLESIA&nbsp;'),
(188, 115, 'POR LA IZQUIERDA', 'CON LA CALLE LOS FLORALES'),
(261, 131, 'POR EL FRENTE', 'COLINDA CON LA CASA DE LA SEÑORA LOLA'),
(262, 131, 'POR EL FONDO', 'COLINDA CON EL TERRENO DEL SEÑOR PEPE'),
(263, 131, 'POR LA DERECHA', 'COLINDA CON EL TERRENO DE PABLO LOPEZ'),
(264, 131, 'POR LA IZQUIERDA', 'COLINDA CON EL TERRENO DE JUANA RAMOS'),
(265, 132, 'POR EL FRENTE', 'COLINDA CON MARIA'),
(266, 132, 'POR EL FONDO', 'COLINDA'),
(267, 132, 'POR LA DERECHA', 'COLINDA'),
(268, 132, 'POR LA IZQUIERDA', 'COLINDA'),
(278, 160, 'POR EL FRENTE', 'Este es el lindero por el frente'),
(279, 160, 'POR EL FONDO', 'Este es el lindero por el fondo'),
(280, 160, 'POR LA DERECHA', 'Este es el lindero por la derecha'),
(281, 160, 'POR LA IZQUIERDA', 'Este es el lindero por la izquierda'),
(282, 160, 'Nuevo', 'Este es un nuevo  Lindero'),
(283, 161, 'POR EL NORTE', 'CON 9.00 M.L. CON LA CALLE ISIDRO FLORES'),
(284, 161, 'POR EL SUR', 'CON 9.00 M.L. CON EL LOTE LL-3'),
(285, 161, 'POR EL ESTE', 'CON 12.00 M.L. CON LA FAMILIA VERA'),
(286, 161, 'POR EL OESTE', 'CON 12.50 M.L. CON EL PASAJE DE ACCESP COMUN '),
(287, 162, 'POR EL FRENTE', 'COLINDA CON EL JR. SOUSA, EN UNA LINEA QUEBRADA DE 1.20+2.85+0.44+2.84+1.21, HACIENDO UN TOTAL DE 8.54 M.L.'),
(288, 162, 'POR EL FONDO', 'COLINDA CON LA PROPIEDAD DE BERLITZA MOLINA GUTIERREZ, EN LINEA RECTA DE 3.15 M.L.'),
(289, 162, 'POR LA DERECHA ENTRANDO', 'COLINDA CON LA PROPIEDAD DE BERLITZA MOLINA GUTIERREZ Y CON LA ESCALERA DE USO COMUN, CON UNA LINEA QUEBRADA DE 4.30+2.50+4.00, HACIENDO UN TOTAL DE 10.80 M.L.'),
(290, 162, 'POR LA IZQUIERDA ENTRANDO', 'COLINDA CON LA PROPIEDAD DE ANTONIO MOSCOSO, EN UNA LINEA QUEBRADA DE 5.30+1.50+3.00, HACIENDO UN TOTAL 9.80 M.L.');
...
CREATE TABLE `pago` (
  ...
  `idvaluacion` int(11) DEFAULT NULL,
  `persona` varchar(250) DEFAULT NULL,
  `monto` decimal(10,2) DEFAULT NULL,
  `descripcion` varchar(250) DEFAULT NULL,
  `COD_USU` varchar(45) DEFAULT NULL,
...
(174, 115, '40113421', 'MARIA SOLEDAD HUARI QUISPE'),
(190, 131, '71234567', 'NILVER SERRANO ESPINOZA'),
(191, 132, '71347265', 'CELENY CINTHIA MELGAREJO SIFUENTES'),
(219, 160, '41745253', 'PERCY IVAN MIRANDA MOREANO'),
(220, 161, '', 'EDSON DAVID GONZALEZ VIZCARRA'),
(221, 162, '29354735', 'ELISA IRENE ANCCA CRUZ');
...
(62, 115, 'AV. GUARDIA CIVIL', 'SRA. ROSA', '987655656', 'A 2 CUADRAS', '800.00', '08/07/2019'),
(63, 115, 'AV. COLONIAL', 'SR. PEDRO LLOSA', '987878786', 'A 3 CUADRAS', '700.00', '08/07/2019'),
(64, 115, 'PASAJE', 'LOS LIRIOS', '988776565', 'A 3 CUADRAS', '750.00', '08/07/2019'),
(65, 131, 'AV. LOS AMAUTAS', 'JUAN SOSA', '987787878', 'A DOS CUADRAS', '1200.00', '04/07/2019'),
(66, 131, 'AV. LOS PINPOS', 'MARIA LOPEZ', '987876675', 'A TRES CUADRAS', '1300.00', '05/07/2019'),
(67, 131, 'JR. JUAN PABLO II', 'YOLANDA PAZ', '987766756', 'A UNA CUADRA', '1500.00', '04/07/2019'),
(68, 132, 'AV', 'LUDDD', '987656543', '2', '900.00', '11/07/2019'),
(69, 132, 'FDF', 'SFSDFDF', '987676764', '4', '800.00', '03/07/2019'),
(76, 160, 'vecino', '', '', '', '200.00', ''),
(77, 160, 'vecino 2', '', '', '', '200.00', ''),
(78, 161, 'Av. Perú a media cuadra de la Cultura Urb Quispicanchis (terreno por 300 m2)', 'Sr: Abarca', '984287565 / 972546013 / 984763773 / 940385298', '6 cuadras', '4000.00', '24/06/2019'),
(79, 161, 'Av. Oswaldo Baca a 1 cuadra de la Collasuyo (terreno por 302 m2 con edificaiond de 2 niveles)', 'Century 21 Fortune Home', '993510386 / 012842456', '3 cuadras', '2615.89', '24/06/2019'),
(80, 161, 'Av. Collasuyo a 1 cuadra del Real Plaza (terreno por 128 m2 con eidifcacion de 5 niveles)', 'Century 21 Fortune Home', '993510386 / 012842456', '5 cuadras', '4296.88', '24/06/2019'),
(81, 161, 'Urb. Santa Monica - wanchaq (terreno por 250m2)', 'Sr: Jorge', '941704484', '5 cuadras', '2223.38', '21/01/2019'),
(82, 161, 'Urb. Santa Monica por Ricardo Plama - Wanchaq (terreno por 250m2)', 'Sr: Alfredo', '984700892', '6 cuadras', '2500.00', '07/02/2019'),
(83, 162, 'Calle Cusco a 1/2 cuadra de la Diaz Barcenas', 'Fam. Pinto Alfaro', '984270845 / 983630530 / 992545478', '1.5 cuadras', '1100.00', '14/02/2019'),
(84, 162, 'Jr.  Andahuaylas a media cuadra del Jr. Arequipa ', 'Fam. Marquina', '965437884 / 983919153', '2.5 cuadras', '2500.00', '06/01/2019'),
(85, 162, 'Jr.  Andahuaylas a media cuadra del Jr. Arequipa ', 'Fam. Ayquipa', '965437884 / 983919153', '2.5 cuadras', '2000.00', '21/03/2019'),
(86, 162, 'Jr. 2 de mayo y Av. Arequipa', 'Fam. Mamani', '983610343 / 950308579', '2.5 cuadras', '2000.00', '12/06/2019');
...
(121, 115, '1.- Valor del Terreno (VT)', '70000.00', '231630.00'),
(122, 115, '2.- Valor de la Edificación (VE)', '100381.99', '332164.00'),
(123, 115, '3.- Valor de las Obras Complementarias (VOC)', '803.87', '2660.00'),
(124, 131, '1.- Valor del Terreno (VT)', '520000.00', '1720680.00'),
(125, 131, '2.- Valor de la Edificación (VE)', '200763.98', '664328.00'),
(126, 131, '3.- Valor de las Obras Complementarias (VOC)', '20670.90', '68400.00'),
(127, 132, '1.- Valor del Terreno (VT)', '70000.00', '231000.00'),
(128, 132, '2.- Valor de la Edificación (VE)', '67631.52', '223184.00'),
(129, 132, '3.- Valor de las Obras Complementarias (VOC)', '2461.36', '8122.50'),
(136, 160, '1.- Valor del Terreno (VT)', '10000.00', '33900.00'),
(137, 160, '2.- Valor de la Edificación (VE)', '29170.65', '98888.50'),
(138, 160, '3.- Valor de las Obras Complementarias (VOC)', '0.00', '0.00'),
(139, 161, '1.- Valor del Terreno (VT)', '255000.00', '838950.00'),
(140, 161, '2.- Valor de la Edificación (VE)', '33779.05', '111133.08'),
(141, 161, '3.- Valor de las Obras Complementarias (VOC)', '0.00', '0.00'),
(142, 162, '1.- Valor del Terreno (VT)', '94536.00', '310550.76'),
(143, 162, '2.- Valor de la Edificación (VE)', '13163.74', '43242.87'),
(144, 162, '3.- Valor de las Obras Complementarias (VOC)', '0.00', '0.00');
...
(326, 115, '1', '1660.82---332164---0---0---332164', 'RESUMEN', '0.00', 1),
(327, 115, '1', 'Muros y columnas', 'B', '327.97', 2),
(328, 115, '1', 'Techos', 'A', '286.64', 3),
(329, 115, '1', 'Pisos', 'C', '109.74', 4),
(330, 115, '1', 'Puertas y ventanas', 'A', '217.57', 5),
(331, 115, '1', 'Revestimiento', 'A', '274.55', 6),
(332, 115, '1', 'Baños', 'A', '97.37', 7),
(333, 115, '1', 'Instalaciones Electricas y Sanitarias', 'A', '346.98', 8),
(334, 131, '1', '1660.82---664328---0---0---664328', 'RESUMEN', '0.00', 1),
(335, 131, '1', 'Muros y columnas', 'B', '327.97', 2),
(336, 131, '1', 'Techos', 'A', '286.64', 3),
(337, 131, '1', 'Pisos', 'C', '109.74', 4),
(338, 131, '1', 'Puertas y ventanas', 'A', '217.57', 5),
(339, 131, '1', 'Revestimiento', 'A', '274.55', 6),
(340, 131, '1', 'Baños', 'A', '97.37', 7),
(341, 131, '1', 'Instalaciones Electricas y Sanitarias', 'A', '346.98', 8),
(342, 132, '1', '2231.84---223184---0---0---223184', 'RESUMEN', '0.00', NULL),
(343, 132, '1', 'Muros y columnas', 'A', '577.43', NULL),
(344, 132, '1', 'Techos', 'A', '295.72', NULL),
(345, 132, '1', 'Pisos', 'A', '360.46', NULL),
(346, 132, '1', 'Puertas y ventanas', 'A', '244.61', NULL),
(347, 132, '1', 'Revestimiento', 'A', '290.05', NULL),
(348, 132, '1', 'Baños', 'A', '105.83', NULL),
(349, 132, '1', 'Instalaciones Electricas y Sanitarias', 'A', '357.74', NULL),
(374, 160, '1', '1977.77---98888.5---0---0---98888.5', 'RESUMEN', '0.00', NULL),
(375, 160, '1', 'Muros y columnas', 'A', '551.27', NULL),
(376, 160, '1', 'Techos', 'A', '286.64', NULL),
(377, 160, '1', 'Pisos', 'A', '203.39', NULL),
(378, 160, '1', 'Puertas y ventanas', 'A', '217.57', NULL),
(379, 160, '1', 'Revestimiento', 'A', '274.55', NULL),
(380, 160, '1', 'Baños', 'A', '97.37', NULL),
(381, 160, '1', 'Instalaciones Electricas y Sanitarias', 'A', '346.98', NULL),
(382, 161, '1', '1210.6---123481.2---10---12348.12---111133.08', 'RESUMEN', '0.00', NULL),
(383, 161, '1', 'Muros y columnas', 'A', '551.27', NULL),
(384, 161, '1', 'Techos', 'A', '286.64', NULL),
(385, 161, '1', 'Pisos', 'D', '89.98', NULL),
(386, 161, '1', 'Puertas y ventanas', 'D', '82.39', NULL),
(387, 161, '1', 'Revestimiento', 'F', '68.86', NULL),
(388, 161, '1', 'Baños', 'C', '45.41', NULL),
(389, 161, '1', 'Instalaciones Electricas y Sanitarias', 'D', '86.05', NULL),
(390, 162, '1', '823.36---43242.87---5---0---43242.87', 'RESUMEN', '0.00', 1),
(391, 162, '1', 'Muros y columnas', 'B', '327.97', 2),
(392, 162, '1', 'Techos', 'B', '197.07', 3),
(393, 162, '1', 'Pisos', 'D', '89.98', 4),
(394, 162, '1', 'Puertas y ventanas', 'E', '62.94', 5),
(395, 162, '1', 'Revestimiento', 'F', '68.86', 6),
(396, 162, '1', 'Baños', 'C', '45.41', 7),
(397, 162, '1', 'Instalaciones Electricas y Sanitarias', 'F', '31.13', 8);
...
(77, 115, 'CERCO PERIMETRICO', '400.00', 4, '5.00', '1520.00', '1600.00'),
(78, 115, 'COBERTURA METALICA', '300.00', 4, '5.00', '1140.00', '1200.00'),
(79, 131, 'CERCO PERIMETRICO', '200.00', 80, '5.00', '15200.00', '16000.00'),
(80, 131, 'COBERTURA METALICA', '160.00', 350, '5.00', '53200.00', '56000.00'),
(81, 132, 'CERCO PERIMETRICO', '90.00', 45, '5.00', '3847.50', '4050.00'),
(82, 132, 'COBERTURA METALICA', '90.00', 50, '5.00', '4275.00', '4500.00'),
(87, 160, 'CERCO PERIMETRICO', '0.00', 0, '5.00', '0.00', '0.00'),
(88, 160, 'COBERTURA METALICA', '0.00', 0, '5.00', '0.00', '0.00'),
(89, 161, 'CERCO PERIMETRICO', '0.00', 0, '5.00', '0.00', '0.00'),
(90, 161, 'COBERTURA METALICA', '0.00', 0, '5.00', '0.00', '0.00'),
(91, 162, 'CERCO PERIMETRICO', '0.00', 0, '5.00', '0.00', '0.00'),
(92, 162, 'COBERTURA METALICA', '0.00', 0, '5.00', '0.00', '0.00');

-- --------------------------------------------------------

--
-- Stand-in structure for view `valoriza_fecha`
-- (See below for the actual view)
--
CREATE TABLE `valoriza_fecha` (
`Codigo` varchar(20)
,`Ciudad` varchar(100)
,`Cliente` varchar(45)
,`Entidad` varchar(45)
,`Contacto` varchar(302)
,`Costo` decimal(10,2)
,`Pagado` decimal(10,2)
,`Saldo` decimal(11,2)
,`Usuario` varchar(20)
...
CREATE TABLE `valuacion` (
  ...
  `COD_USU` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `valuacion` (`idvaluacion`, `nroValuacion`, `tipoinmueble`, `fechavaluacion`, `a101`, `a102a`, `a102b`, `a103a`, `a103b`, `a104a`, `a104b`, `a201`, `a202`, `a203a`, `a203b`, `a203c`, `a204`, `a301`, `a302`, `a302a`, `a302b`, `a302c`, `a302d`, `a303a`, `a303b`, `a304`, `a304a`, `a304b`, `a305`, `a306`, `a307a`, `a307b`, `a307c`, `a307d`, `a307e`, `a307f`, `a307g`, `a307h`, `a307i`, `a308`, `a309`, `a309a`, `a400`, `a500`, `a600`, `a700`, `b800`, `b900a`, `b900b`, `b1000a`, `b1000b`, `b1000c`, `b1000d`, `b1000e`, `b1100a`, `b1100b`, `c1200`, `c1300`, `c1400`, `c1400a`, `c1400b`, `c1400c`, `c1400d`, `c1400e`, `c1400f`, `c1500a`, `c1500b`, `c1500c`, `c1500d`, `c1500e`, `c1500f`, `c1500g`, `c1600`, `c1700`, `d1800a`, `d1800b`, `d1800c`, `d1800d`, `d1901a`, `d1901b`, `d1901c`, `d1901d`, `d1902`, `d1902a`, `d1902b`, `d1902c`, `d1902d`, `d1902e`, `d1902f`, `d1903a`, `d1903b`, `d1903c`, `d1903d`, `d1903e`, `d1903f`, `d1903g`, `d1903h`, `d1903i`, `d1903j`, `d1903k`, `d1903l`, `e2000`, `e2100`, `e2200`, `e2300`, `e2400`, `e2500`, `e2600`, `e2700`, `e2800a`, `e2800b`, `e2800c`, `e2800d`, `e2800e`, `e2800f`, `e2900a`, `e2900b`, `e2900c`, `e2900d`, `e3000a`, `e3000b`, `e3000c`, `registro`, `idcontacto`, `costo`, `pago`, `COD_USU`) VALUES
(115, '1-2019', 'RURAL', '2019-07-09', 'Determinar el valor comercial y el de realización en el mercado del inmueble URBANO  de acuerdo a la Rs. S.B.S. N° 880 de fecha 15 de diciembre de 1997, modificada por las Resoluciones SBS N° 816-2005 y 12879 -2009, R.M.  Nº 172-2016-VIVIENDA', NULL, NULL, '31349421', 'VALERIO MERINO RUIZ', '', 'CAJA LOS ANDES', 'S EENCUENTRA A UNA CUADRA DE LA CAJA AREQUIPA', 'LOTE DE TERRENO EN BUENA UBICACION', '05', '01', '01', 'NO CUENTA', 'RURAL', 'PROPIA', NULL, NULL, NULL, NULL, '100.00', '40.00', '200.00', NULL, NULL, 'Vivienda', 'EL PREDIO SE ENCUENTRA EN LA AV.LOS PAISAJES, EN LA PROVINCIA DE HUAMANGA AYACUCHO', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No cuenta con servidumbre para con las propiedades vecinas', 'No se encuentra inscrita', '0.00', 'Vivienda', 'La valuación es para determinar el valor comercial del predio.\\nNo hubo ninguna objeción para efectuar la evaluación y valuación del inmueble', '2019-07-09', 'No cuenta con Poliza de Seguros', '2019-07-09', 'CAJA LOS ANDES', 'PROPIA', '123', '123', '123', '123', '123', 'Sin información', 'Sin información', 'Se ha realizado una visita de inspección de campo a la vez el entorno del predio, para determinar valores comerciales de compra y venta de inmuebles con caracerísticas similares.', 'El trabajo que se realiza en concordancia a lo establecido por las normas vigentes del SBS y el ReglamentoNacional de Tazaciones del Perú. ', 'Se consideró una investigación en el entorno del inmueble durante la inspección, revisión de avisos económicos y la base de datos del perito.', '750.00', '700.00', '3.3090', '2316.30', 'Se toma el valor considerando las referencias y predios de características similares, con un criterio conservador y prudente asi mismo por encontrarse en la misma esquina.', 'assets/uploads/FB_IMG_1487563499700.jpg', 4, 4, 3, 3, 14, '70.0000', 'Garantía Hipotecaria Preferida', '30.0000', 'El análisis efectuado nos permite indicar que las apreciaciones son las más razonables para determinar el valor del bien.', '100.00', '700.00', '70000.00', '3.3090', '100.00', '700.00', '70000.00', '231630.00', 'SIERRA', '332164.00', NULL, NULL, NULL, NULL, NULL, '2660.00', 'Seleccione...', 3, '171185.86', '566454.00', '70.00', '119830.10', '396517.80', 'CIENTO DIECINUEVE MIL OCHOCIENTOS TREINTA  CON 10/100 DÓLARES AMERICANOS', '101228.17', '334964.00', '3.3090', ' La presente  valuación se ha efectuado con total independencia, aplicada un criterio prudente y conservador en la determinación del valor.', ' En la determinación del valor se aplicaron las normas vigentes reconocidas por la S.B.S y el Reglamento Nacional de Tasaciones del Perú. Rs. S.B.S. N° 11356-2008, R.M.  Nº 172-2016-VIVIENDA.', ' Declaro bajo juramento, no tener ningún tipo de vinculación familiar, económico, relación laboral entre el propietario, cliente y/o solicitante en la presente valorización.', ' Si no varían las edificaciones del mercado, así como no se surgir imponderables la valuación tiene una vigencia de: 90 días.', 'MARIA SOLEDAD HUARI QUISPE', 'VALERIO MERINO RUIZ', '. Ubicación del predio		\r\n. Servicios de Infraestructura instalados: accesibilidad, pistas, agua potable, desague, electricidad y Comunicaciones.			\r\n. Accesos directos desde la via pública.\r\n. Uso actual.			\r\n. Zonificación.\r\n. Equipamiento urbano que posee la zona.			\r\n. Visita de inspección.\r\n. Valor comercial del mercado inmobiliario.			\r\n. Caracteristicas de la Edificación.					\r\n. Influencia poblacional.					\r\n', 'S ERECOMIENDA QUE EL PREDIO ESTA A UN PRECIO A SER VENDIDO', 'EN PROCESO', 'EN PROCESO', 'EN PROCESO', 'EN PROCESO', 'EN PROCESO', 'EN PROCESO', 'Cyntia Flor Ochoa Pino', 'Arquitecto', '12452', 'EN PROCESO;Vigente', 'assets/uploads/images.jpg', 'assets/uploads/IMG-20160825-WA0003.jpg', 'assets/uploads/IMG-20160825-WA0005.jpg', '2019-07-09 19:25:24', 13, NULL, NULL, 'gise'),
(131, '2-2019', 'URBANO', '2019-07-11', 'Determinar el valor comercial y el de realización en el mercado del inmueble URBANO  de acuerdo a la Rs. S.B.S. N° 880 de fecha 15 de diciembre de 1997, modificada por las Resoluciones SBS N° 816-2005 y 12879 -2009, R.M.  Nº 172-2016-VIVIENDA', NULL, NULL, '70865274', 'GISELA MERINO RIVERA', '', 'BANCO DE CRÉDITO DEL PERÚ', 'SE ENCUENTRA A TRES CUADRAS DE LA PLAZA DE ARMAS', 'LOTE DE TERRENO ADECUADO PARA VENTA', '06', '01', '01', 'LOTE DE TERRENO NUEVO', 'URBANO', 'PROPIA', NULL, NULL, NULL, NULL, '400.00', '80.00', '600.00', NULL, NULL, 'Vivienda;Almacen;Departamento', 'EL PREDIO SE ENCUENTRA EN LA AV. LOS CLAVELES , LOTE DE TERRENO ......', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No cuenta con servidumbre para con las propiedades vecinas', 'No se encuentra inscrita', '0.00', 'Almacen;Departamento', 'La valuación es para determinar el valor comercial del predio. No hubo ninguna objeción para efectuar la evaluación y valuación del inmueble', '2019-07-10', 'No cuenta con Poliza de Seguros', '2019-07-10', 'BANCO DE CREDITO DEL PERU', 'PROPIA', 'CAJAMARCA', '123', '12', '12', 'CAJ-123', 'Sin información', 'Sin información', 'Se ha realizado una visita de inspección de campo a la vez el entorno del predio, para determinar valores comerciales de compra y venta de inmuebles con caracerísticas similares.', 'El trabajo que se realiza en concordancia a lo establecido por las normas vigentes del SBS y el ReglamentoNacional de Tazaciones del Perú. ', 'Se consideró una investigación en el entorno del inmueble durante la inspección, revisión de avisos económicos y la base de datos del perito.', '1333.33', '1300.00', '3.3090', '4301.70', 'Se toma el valor considerando las referencias y predios de características similares, con un criterio conservador y prudente asi mismo por encontrarse en la misma esquina.', 'assets/uploads/CUCHARITAS.jpeg', 4, 5, 5, 5, 19, '95.0000', 'Garantía Hipotecaria Preferida', '5.0000', 'El análisis efectuado nos permite indicar que las apreciaciones son las más razonables para determinar el valor del bien.', '400.00', '1300.00', '520000.00', '3.3090', '400.00', '1300.00', '520000.00', '1720680.00', 'SIERRA', '664328.00', NULL, NULL, NULL, NULL, NULL, '68400.00', 'Seleccione...', 2, '741434.88', '2453408.00', '95.00', '704363.14', '2330737.60', 'SETECIENTOS CUATRO MIL TRESCIENTOS SESENTA Y TRES  CON 14/100 DÓLARES AMERICANOS', '222522.82', '736328.00', '3.3090', ' La presente  valuación se ha efectuado con total independencia, aplicada un criterio prudente y conservador en la determinación del valor.', ' En la determinación del valor se aplicaron las normas vigentes reconocidas por la S.B.S y el Reglamento Nacional de Tasaciones del Perú. Rs. S.B.S. N° 11356-2008, R.M.  Nº 172-2016-VIVIENDA.', ' Declaro bajo juramento, no tener ningún tipo de vinculación familiar, económico, relación laboral entre el propietario, cliente y/o solicitante en la presente valorización.', ' Si no varían las edificaciones del mercado, así como no se surgir imponderables la valuación tiene una vigencia de: 90 días.', 'NILVER SERRANO ESPINOZA', 'GISELA MERINO RIVERA', '. Ubicación del predio		\r\n. Servicios de Infraestructura instalados: accesibilidad, pistas, agua potable, desague, electricidad y Comunicaciones.			\r\n. Accesos directos desde la via pública.\r\n. Uso actual.			\r\n. Zonificación.\r\n. Equipamiento urbano que posee la zona.			\r\n. Visita de inspección.\r\n. Valor comercial del mercado inmobiliario.			\r\n. Caracteristicas de la Edificación.					\r\n. Influencia poblacional.					\r\n', '', 'P', 'P', 'P', 'P', 'P', 'P', 'Cyntia Flor Ochoa Pino', 'Arquitecto', '12452', 'P;Vigente', 'assets/uploads/porta2.jpg', 'assets/uploads/ramen3.jpeg', 'assets/uploads/PIZARRA1.jpeg', '2019-07-11 00:40:44', 18, '300.00', '100.00', 'gise'),
(132, '3-2019', 'URBANO', '2019-07-11', 'Determinar el valor comercial y el de realización en el mercado del inmueble URBANO  de acuerdo a la Rs. S.B.S. N° 880 de fecha 15 de diciembre de 1997, modificada por las Resoluciones SBS N° 816-2005 y 12879 -2009, R.M.  Nº 172-2016-VIVIENDA', NULL, NULL, '72376567', 'ERIKA DAYANNE ORDOÑEZ CANCHARI', '', 'CMAC PIURA S.A.C.', 'FRACCION \"C-21-B\" DEL LOTE DE TERRENO N°21 DE LA MANZANA C DE LA ASOCIACION DE PEQUEÑOS ', 'APP PAMPACHACRA CA LOS ALAMOS MZ. C LT. 21B', '01', '01', '01', 'APP PAMPACHACRA CA LOS ALAMOS MZ. C LT. 21B', 'URBANO', 'PROPIA', NULL, NULL, NULL, NULL, '100.00', '40.00', '100.00', NULL, NULL, 'Vivienda', 'EL PREDIOSNXASDSDJSDASDSAD', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No cuenta con servidumbre para con las propiedades vecinas', 'No se encuentra inscrita', '0.00', 'Vivienda', 'La valuación es para determinar el valor comercial del predio. No hubo ninguna objeción para efectuar la evaluación y valuación del inmueble', '2019-07-11', 'No cuenta con Poliza de Seguros', '2019-07-11', 'CAC PIURA', 'PROPIA', 'CHACHAPOYAS', '233', '233', '234', '233', 'Sin información', 'Sin información', 'Se ha realizado una visita de inspección de campo a la vez el entorno del predio, para determinar valores comerciales de compra y venta de inmuebles con caracerísticas similares.', 'El trabajo que se realiza en concordancia a lo establecido por las normas vigentes del SBS y el ReglamentoNacional de Tazaciones del Perú. ', 'Se consideró una investigación en el entorno del inmueble durante la inspección, revisión de avisos económicos y la base de datos del perito.', '850.00', '700.00', '3.3000', '2310.00', 'Se toma el valor considerando las referencias y predios de características similares, con un criterio conservador y prudente asi mismo por encontrarse en la misma esquina.', 'assets/uploads/STRAWBERRYPINKK.jpg', 5, 3, 4, 3, 15, '75.0000', 'Garantía Hipotecaria Preferida', '25.0000', 'El análisis efectuado nos permite indicar que las apreciaciones son las más razonables para determinar el valor del bien.', '100.00', '700.00', '70000.00', '3.3000', '100.00', '700.00', '70000.00', '231000.00', 'SELVA', '223184.00', NULL, NULL, NULL, NULL, NULL, '8122.50', 'Regular', 5, '140092.88', '462306.50', '75.00', '105069.66', '346729.88', 'CIENTO CINCO MIL SESENTA Y NUEVE  CON 66/100 DÓLARES AMERICANOS', '70222.42', '231734.00', '3.3000', ' La presente  valuación se ha efectuado con total independencia, aplicada un criterio prudente y conservador en la determinación del valor.', ' En la determinación del valor se aplicaron las normas vigentes reconocidas por la S.B.S y el Reglamento Nacional de Tasaciones del Perú. Rs. S.B.S. N° 11356-2008, R.M.  Nº 172-2016-VIVIENDA.', ' Declaro bajo juramento, no tener ningún tipo de vinculación familiar, económico, relación laboral entre el propietario, cliente y/o solicitante en la presente valorización.', ' Si no varían las edificaciones del mercado, así como no se surgir imponderables la valuación tiene una vigencia de: 90 días.', 'CELENY CINTHIA MELGAREJO SIFUENTES', 'ERIKA DAYANNE ORDOÑEZ CANCHARI', '. Ubicación del predio		\r\n. Servicios de Infraestructura instalados: accesibilidad, pistas, agua potable, desague, electricidad y Comunicaciones.			\r\n. Accesos directos desde la via pública.\r\n. Uso actual.			\r\n. Zonificación.\r\n. Equipamiento urbano que posee la zona.			\r\n. Visita de inspección.\r\n. Valor comercial del mercado inmobiliario.			\r\n. Caracteristicas de la Edificación.					\r\n. Influencia poblacional.					\r\n', 'FDFGFGFGTR', 'YRTY', 'RTYRTY', 'RTYRYR', 'RTYRY', 'RTYRTYR', 'RTYTRU', 'Cyntia Flor Ochoa Pino', 'Arquitecto', '12452', 'Vigente', 'assets/uploads/MAKIS3.jpeg', 'assets/uploads/MAKIS7.jpeg', 'assets/uploads/MAKIS6.jpeg', '2019-07-11 01:55:46', 17, NULL, NULL, 'gise'),
(160, '4-2019', 'URBANO', '2019-07-16', 'Determinar el valor comercial y el de realización en el mercado del inmueble URBANO  de acuerdo a la Rs. S.B.S. N° 880 de fecha 15 de diciembre de 1997, modificada por las Resoluciones SBS N° 816-2005 y 12879 -2009, R.M.  Nº 172-2016-VIVIENDA', NULL, NULL, '', 'AZMABETH ESMITA VARGAS NACHINARI', '20255993225', 'CREDISCOTIA FINANCIERA S.A.', 'Este es un dato registral', 'Este es un autovaluo', '03', '01', '01', 'Este es un dato', 'URBANO', 'Esta es una fuente', NULL, NULL, NULL, NULL, '100.00', '120', '100.00', NULL, NULL, 'Vivienda;Almacen', 'Esta es una descripción', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No cuenta con servidumbre para con las propiedades vecinas', 'No se encuentra inscrita', '100.00', 'Vivienda;Almacen', 'La valuación es para determinar el valor comercial del predio. No hubo ninguna objeción para efectuar la evaluación y valuación del inmueble', '2019-07-16', 'No cuenta con Poliza de Seguros', '2019-07-16', 'Credi Scotia', 'una fuente', 'Esta es la oficina', 'Este es el código', '23', '232323', 'Esta es la partida', 'Sin información', 'Sin información', 'Se ha realizado una visita de inspección de campo a la vez el entorno del predio, para determinar valores comerciales de compra y venta de inmuebles con caracerísticas similares.', 'El trabajo que se realiza en concordancia a lo establecido por las normas vigentes del SBS y el ReglamentoNacional de Tazaciones del Perú. ', 'Se consideró una investigación en el entorno del inmueble durante la inspección, revisión de avisos económicos y la base de datos del perito.', '200.00', '100.00', '3.3900', '339.00', 'Se toma el valor considerando las referencias y predios de características similares, con un criterio conservador y prudente asi mismo por encontrarse en la misma esquina.', 'assets/uploads/3243243242.jpg', 4, 4, 4, 4, 16, '80.0000', 'Garantía Hipotecaria Preferida', '20.0000', 'El análisis efectuado nos permite indicar que las apreciaciones son las más razonables para determinar el valor del bien.', '100.00', '100.00', '10000.00', '3.3900', '100.00', '100.00', '10000.00', '33900.00', 'SIERRA', '98888.50', NULL, NULL, NULL, NULL, NULL, '0.00', 'Seleccione...', 0, '39170.65', '132788.50', '80.00', '31336.52', '106230.80', 'TREINTA Y UN MIL TRESCIENTOS TREINTA Y SEIS  CON 52/100 DÓLARES AMERICANOS', '29170.65', '98888.50', '3.3900', ' La presente  valuación se ha efectuado con total independencia, aplicada un criterio prudente y conservador en la determinación del valor.', ' En la determinación del valor se aplicaron las normas vigentes reconocidas por la S.B.S y el Reglamento Nacional de Tasaciones del Perú. Rs. S.B.S. N° 11356-2008, R.M.  Nº 172-2016-VIVIENDA.', ' Declaro bajo juramento, no tener ningún tipo de vinculación familiar, económico, relación laboral entre el propietario, cliente y/o solicitante en la presente valorización.', ' Si no varían las edificaciones del mercado, así como no se surgir imponderables la valuación tiene una vigencia de: 90 días.', 'PERCY IVAN MIRANDA MOREANO', '', '. Ubicación del predio		\r\n. Servicios de Infraestructura instalados: accesibilidad, pistas, agua potable, desague, electricidad y Comunicaciones.			\r\n. Accesos directos desde la via pública.\r\n. Uso actual.			\r\n. Zonificación.\r\n. Equipamiento urbano que posee la zona.			\r\n. Visita de inspección.\r\n. Valor comercial del mercado inmobiliario.			\r\n. Caracteristicas de la Edificación.					\r\n. Influencia poblacional.					\r\n', '', 'a', 'b', 'c', 'd', 'e', 'f', 'Cyntia Flor Ochoa Pino', 'Arquitecto', '12452', 'Vigente', 'assets/uploads/23432.jpg', 'assets/uploads/54654.jpg', '', '2019-07-16 13:24:58', 13, '500.00', '300.00', 'Admin'),
(161, '5-2019', 'URBANO', '2019-07-18', 'Determinar el valor comercial y el de realización en el mercado del inmueble URBANO  de acuerdo a la Rs. S.B.S. N° 880 de fecha 15 de diciembre de 1997, modificada por las Resoluciones SBS N° 816-2005 y 12879 -2009, R.M.  Nº 172-2016-VIVIENDA', NULL, NULL, '40595382', 'ROXANA PEÑALVA INCAQUIHUI', '20100043140', 'SCOTIABANK PERU SAA', 'DEPARTAMENTO \"B\" INTEGRANTE DEL INMUEBLE N°212 DE LA AVENIDA JOSE GABRIEL COSIO, DE LA URBANIZACIÓN MAGISTERIAL PRIMERA ETAPA ', 'URB. MAGISTERIAL 1° ETAPA N° 212 DEP. B', '08', '01', '01', '', 'URBANO', 'CRI:11/07/2019', NULL, NULL, NULL, NULL, '102.00', '0.00', '102.00', NULL, NULL, 'Departamento', 'El predio se encuentra ubicado en la Av. Jose Gabriel Cosio Urb. Magisterial Primera Etapa, se encuentra frente a la Plaza Amauta, a 1 cuadra de la Plaza El Trebol, a 2 cuadras del Consulado de Bolivia, a 2 cuadras de la Caja Metropolitana, a 2.5 cuadras de Scotiabank, a 3 cuadras del Colegio San Antonio Abad, a 4 cuadras del Real Plaza, alrededor se encuentran viviendas, departamentos, locales comerciales, entre otros.  La zona cuenta con servicios de agua, luz, desagüe, y la vía de acceso es de pavimento rigido. La tendencia de los valores de mercado en esta zona es creciente.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No cuenta con servidumbre para con las propiedades vecinas', 'No se encuentra inscrita', '0.00', 'Vivienda;Departamento;Local Comercial', 'La valuación es para determinar el valor comercial del predio. No hubo ninguna objeción para efectuar la evaluación y valuación del inmueble', '2019-07-18', 'No cuenta con Poliza de Seguros', '2019-07-17', 'NINGUNO', 'CRI: 11/07/2019', 'CUSCO', '', '', '', '05002406', 'Sin información', 'Sin información', 'Se ha realizado una visita de inspección de campo a la vez el entorno del predio, para determinar valores comerciales de compra y venta de inmuebles con caracerísticas similares.', 'El trabajo que se realiza en concordancia a lo establecido por las normas vigentes del SBS y el ReglamentoNacional de Tazaciones del Perú. ', 'Se consideró una investigación en el entorno del inmueble durante la inspección, revisión de avisos económicos y la base de datos del perito.', '3127.23', '2500.00', '3.2900', '8225.00', 'Se toma el valor considerando las referencias y predios de características similares, con un criterio conservador y prudente asi mismo por encontrarse en la misma esquina.', '', 4, 4, 4, 4, 16, '80.0000', 'Garantía Hipotecaria Preferida', '20.0000', 'El análisis efectuado nos permite indicar que las apreciaciones son las más razonables para determinar el valor del bien.', '102.00', '2500.00', '255000.00', '3.2900', '102.00', '2500.00', '255000.00', '838950.00', 'Seleccione...', '111133.08', NULL, NULL, NULL, NULL, NULL, '0.00', 'Seleccione...', 0, '288779.05', '950083.08', '80.00', '231023.24', '760066.46', 'DOSCIENTOS TREINTA Y TRES MIL SETECIENTOS VEINTICINCO  CON 57/100 DÓLARES AMERICANOS', '37532.28', '123481.20', '3.2900', ' La presente  valuación se ha efectuado con total independencia, aplicada un criterio prudente y conservador en la determinación del valor.', ' En la determinación del valor se aplicaron las normas vigentes reconocidas por la S.B.S y el Reglamento Nacional de Tasaciones del Perú. Rs. S.B.S. N° 11356-2008, R.M.  Nº 172-2016-VIVIENDA.', ' Declaro bajo juramento, no tener ningún tipo de vinculación familiar, económico, relación laboral entre el propietario, cliente y/o solicitante en la presente valorización.', ' Si no varían las edificaciones del mercado, así como no se surgir imponderables la valuación tiene una vigencia de: 90 días.', 'DEL TUTULAR', 'ROXANA PEÑALVA INCAQUIHUI', '. Ubicación del predio		\r\n. Servicios de Infraestructura instalados: accesibilidad, pistas, agua potable, desague, electricidad y Comunicaciones.			\r\n. Accesos directos desde la via pública.\r\n. Uso actual.			\r\n. Zonificación.\r\n. Equipamiento urbano que posee la zona.			\r\n. Visita de inspección.\r\n. Valor comercial del mercado inmobiliario.			\r\n. Caracteristicas de la Edificación.					\r\n. Influencia poblacional.					\r\n', '', '*', '*', '*', '', '', '', 'Cyntia Flor Ochoa Pino', 'Arquitecto', '12452', 'Vigente', '', 'assets/uploads/WhatsApp Image 2019-07-17 at 18.07.52 (1).jpeg', '', '2019-07-18 13:00:31', 0, '0.00', '0.00', 'Admin'),
(162, '6-2019', 'URBANO', '2019-07-18', 'Determinar el valor comercial y el de realización en el mercado del inmueble URBANO  de acuerdo a la Rs. S.B.S. N° 880 de fecha 15 de diciembre de 1997, modificada por las Resoluciones SBS N° 816-2005 y 12879 -2009, R.M.  Nº 172-2016-VIVIENDA', NULL, NULL, '', 'WALDO JUSAN CARDENAS HUAMAN, LUZDELIA BEATRIZ', '', 'CMAC PIURA S.A.C.', 'JR. SOUSA N° 108', 'JR. SOUSA N° 108', '03', '01', '01', 'JR. SOUSA N° 108', 'URBANO', 'CRI 20/05/2019.', NULL, NULL, NULL, NULL, '52.52', '0.00', '52.52', NULL, NULL, NULL, 'El Predio se encuentra ubicado en la Jr. Grau N° 105, próximo a la Av.  Arequipa, aproximadamente a 10 metros del Hotel Turistas de Abancay, a 1.5 cuadras de BITEL Centro de Atención al Cliente, a 1 cuadra de la I.E.  MAJESA, alrededor se encuentran imprentas, tiendas, oficinas, hospedajes, cuenta con servicios de agua, luz, desague y la via de acceso es de pavimento rigido. La tendencia de los valores de mercado en esta zona comercial es creciente.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'No cuenta con servidumbre para con las propiedades vecinas', 'No se encuentra inscrita', '0.00', 'Vivienda;Departamento;Local Comercial', 'La valuación es para determinar el valor comercial del predio. No hubo ninguna objeción para efectuar la evaluación y valuación del inmueble', '2019-07-18', 'No cuenta con Poliza de Seguros', '2019-08-17', 'NINGUNO', '', 'ABANCAY', '', '', '', '11036026', 'Sin información', 'Sin información', 'Se ha realizado una visita de inspección de campo a la vez el entorno del predio, para determinar valores comerciales de compra y venta de inmuebles con caracerísticas similares.', 'El trabajo que se realiza en concordancia a lo establecido por las normas vigentes del SBS y el ReglamentoNacional de Tazaciones del Perú. ', 'Se consideró una investigación en el entorno del inmueble durante la inspección, revisión de avisos económicos y la base de datos del perito.', '1900.00', '1800.00', '3.2850', '5913.00', 'Se toma el valor considerando las referencias y predios de características similares, con un criterio conservador y prudente asi mismo por encontrarse en la misma esquina.', '', 4, 4, 4, 4, 16, '80.0000', 'Garantía Hipotecaria Preferida', '20.0000', 'El análisis efectuado nos permite indicar que las apreciaciones son las más razonables para determinar el valor del bien.', '52.52', '1800.00', '94536.00', '3.2850', '52.52', '1800.00', '94536.00', '310550.76', 'Seleccione...', '43242.87', NULL, NULL, NULL, NULL, NULL, '0.00', 'Seleccione...', 0, '107699.74', '353793.63', '80.00', '86159.79', '283034.90', 'OCHENTA Y SEIS MIL CIENTO CINCUENTA Y NUEVE  CON 79/100 DÓLARES AMERICANOS', '13163.74', '43242.87', '3.2850', ' La presente  valuación se ha efectuado con total independencia, aplicada un criterio prudente y conservador en la determinación del valor.', ' En la determinación del valor se aplicaron las normas vigentes reconocidas por la S.B.S y el Reglamento Nacional de Tasaciones del Perú. Rs. S.B.S. N° 11356-2008, R.M.  Nº 172-2016-VIVIENDA.', ' Declaro bajo juramento, no tener ningún tipo de vinculación familiar, económico, relación laboral entre el propietario, cliente y/o solicitante en la presente valorización.', ' Si no varían las edificaciones del mercado, así como no se surgir imponderables la valuación tiene una vigencia de: 90 días.', '', '  ', '. Ubicación del predio		\r\n. Servicios de Infraestructura instalados: accesibilidad, pistas, agua potable, desague, electricidad y Comunicaciones.			\r\n. Accesos directos desde la via pública.\r\n. Uso actual.			\r\n. Zonificación.\r\n. Equipamiento urbano que posee la zona.			\r\n. Visita de inspección.\r\n. Valor comercial del mercado inmobiliario.			\r\n. Caracteristicas de la Edificación.					\r\n. Influencia poblacional.					\r\n', '', '', '', '', '', '', '', 'Cyntia Flor Ochoa Pino', 'Arquitecto', '12452', 'Vigente', '', '', '', '2019-07-18 13:06:54', 0, '0.00', '0.00', 'Admin');

-- --------------------------------------------------------

--
-- Structure for view `contactoval`
--
DROP TABLE IF EXISTS `contactoval`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `contactoval`  AS  select `c`.`idcontacto` AS `idcontacto`,concat(`c`.`NOM_CONT`,' ',`c`.`APP_CONT`,' ',`c`.`APM_CONT`) AS `Nombres_y_Apellidos`,`c`.`DNI_CONT` AS `DNI_CONT`,`c`.`FENAC_CONT` AS `FENAC_CONT`,`c`.`TEL_CONT` AS `TEL_CONT`,`c`.`EMAIL_CONT` AS `EMAIL_CONT`,`va`.`nroValuacion` AS `nroValuacion`,`va`.`a104b` AS `a104b`,count(`va`.`idvaluacion`) AS `cantidad`,sum(ifnull(`va`.`costo`,0)) AS `costo`,sum(ifnull(`va`.`pago`,0)) AS `pago`,`c`.`OBS_CONT` AS `OBS_CONT` from (`contacto` `c` join `valuacion` `va` on((`c`.`idcontacto` = `va`.`idcontacto`))) group by `c`.`idcontacto` ;

-- --------------------------------------------------------

--
-- Structure for view `contactovaluacion`
--
DROP TABLE IF EXISTS `contactovaluacion`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `contactovaluacion`  AS  select `c`.`idcontacto` AS `idcontacto`,concat(`c`.`NOM_CONT`,' ',`c`.`APP_CONT`,' ',`c`.`APM_CONT`) AS `Nombres_y_Apellidos`,`c`.`DNI_CONT` AS `DNI_CONT`,`c`.`FENAC_CONT` AS `FENAC_CONT`,`c`.`TEL_CONT` AS `TEL_CONT`,`c`.`EMAIL_CONT` AS `EMAIL_CONT`,count(`va`.`idvaluacion`) AS `CANTIDAD` from (`contacto` `c` join `valuacion` `va` on((`c`.`idcontacto` = `va`.`idcontacto`))) group by `c`.`idcontacto` ;

-- --------------------------------------------------------

--
-- Structure for view `valoriza_fecha`
--
DROP TABLE IF EXISTS `valoriza_fecha`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `valoriza_fecha`  AS  select `va`.`nroValuacion` AS `Codigo`,`ub`.`C_NOMUBIGEO` AS `Ciudad`,`va`.`a103b` AS `Cliente`,`va`.`a104b` AS `Entidad`,concat(`co`.`APP_CONT`,' ',`co`.`APM_CONT`,' ',`co`.`NOM_CONT`) AS `Contacto`,ifnull(`va`.`costo`,0) AS `Costo`,ifnull(`va`.`pago`,0) AS `Pagado`,(ifnull(`va`.`costo`,0) - ifnull(`va`.`pago`,0)) AS `Saldo`,`va`.`COD_USU` AS `Usuario`,`va`.`registro` AS `Registro` from ((`valuacion` `va` join `ubigeo` `ub` on((concat(`va`.`a203a`,`va`.`a203b`,`va`.`a203c`) = `ub`.`C_CODUBIGEO`))) join `contacto` `co` on((`va`.`idcontacto` = `co`.`idcontacto`))) ;
...
--
ALTER TABLE `contacto`
  MODIFY `idcontacto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `edificacion`
--
ALTER TABLE `edificacion`
  MODIFY `idedificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=208;

--
-- AUTO_INCREMENT for table `fabrica`
--
ALTER TABLE `fabrica`
  MODIFY `idfabrica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT for table `foto`
--
ALTER TABLE `foto`
  MODIFY `idfoto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;

--
-- AUTO_INCREMENT for table `lindero`
--
ALTER TABLE `lindero`
  MODIFY `idlindero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=291;
...
--
ALTER TABLE `propietario`
  MODIFY `idpropietario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=222;

--
-- AUTO_INCREMENT for table `referencia`
--
ALTER TABLE `referencia`
  MODIFY `idreferencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT for table `sintesis`
--
ALTER TABLE `sintesis`
  MODIFY `idsintesis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;

--
-- AUTO_INCREMENT for table `valor`
--
ALTER TABLE `valor`
  MODIFY `idvalor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=398;

--
-- AUTO_INCREMENT for table `valorcomplementario`
--
ALTER TABLE `valorcomplementario`
  MODIFY `idvalorcomplementario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;

--
-- AUTO_INCREMENT for table `valuacion`
--
ALTER TABLE `valuacion`
  MODIFY `idvaluacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=163;
COMMIT;
