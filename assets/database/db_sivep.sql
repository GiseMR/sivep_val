...
(0, '11223334', 'Juan', 'Perez', 'Maldonado', '1999-05-12', 987666554, 'juancito@gmail.com', '234.00', ''),
...
(1, 'Inicio', 'mdi mdi-view-dashboard', 'inicio/main', 1, 1),
(2, 'Valorizaciones', 'mdi mdi-border-inside', '#', 2, 1),
(3, 'Usuarios', 'mdi mdi-account-key', 'usuario', 3, 1),
(4, 'Contactos', 'mdi mdi-account', 'contacto', 4, 1),
(5, 'Reportes', 'mdi mdi-chart-bar', 'reporte', 5, 1);
