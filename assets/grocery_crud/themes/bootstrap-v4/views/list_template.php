                ...
                <div class="table-container">
                    <?php echo form_open("", 'method="post" autocomplete="off" id="gcrud-search-form"'); ?>
                        <div class="header-tools">
                            <?php if(!$unset_add){?>
                                <div class="floatL t5">
                                    <a class="btn btn-default btn-outline-dark add" href="<?php echo $add_url?>">
                            ...
                            <div class="floatR">
                                ...
                                <div class="btn-group floatR t10 l10 settings-button-container" style="margin-top:6px">
        					...
        					<thead>
        						...
        						<tr class="filter-row gc-search-row">
        							...
        							<td class="no-border-left <?php if ($buttons_counter === 0) {?>hidden<?php }?>">
                                        ...
                                        <div class="floatR l5">
                                            <a href="javascript:void(0);" class="btn btn-default btn-sm btn-outline-dark gc-refresh">
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <td>
                                            <input
                                                type="text"
                                                class="form-control form-control-sm searchable-input floatL"
        					...
        					<div class="footer-tools">
                                            ...
                                            <div class="floatL t0 l5">
                                                ...
                                                <div class="floatL r5 l5">
                                                    <select name="per_page" class="per_page form-control form-control-sm">
