...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="64x64" href="<?= base_url() ?>assets/matrix/assets/images/logo.png">
  <title>SIVEP</title>
  <!-- Custom CSS -->
  ...
  <div id="main-wrapper">
        ...
        <div class="navbar-header" data-logobg="skin5">
          ...
          <a class="navbar-brand" href="index.html">
            ...
            <b class="logo-icon p-l-10">
              ...
              <!-- Dark Logo icon -->
              <!--<img src="<?= base_url() ?>assets/matrix/assets/images/logo-icon.png" alt="homepage" class="light-logo" />-->
              <h1>S</h1>
            </b>
            <!--End Logo icon -->
            <!-- Logo text -->
            <span class="logo-text">
              <!-- dark Logo text -->
              <!--<img src="<?= base_url() ?>assets/matrix/assets/images/logo-text.png" alt="homepage" class="light-logo" />-->
              <h1>IVEP</h1>
            </span>
          </a>
          <!-- ============================================================== -->
    ...
    <script>
      ...
      function resizeFromIframe() {
        setTimeout(function() {
          document.getElementById("content-frame").style.height = document.getElementById("content-frame").contentWindow.document.body.scrollHeight + 'px';
        }, 250);
