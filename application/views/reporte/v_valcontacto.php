...
<head>
    ...
    <title>CONTACTO CON MAS VALORIZACIONES</title>
    <!-- Custom CSS -->
                    ...
                    <body>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h3 class="card text-center">LISTA DE CONTACTO CON MAS VALORIZACIONES</h3>
                                            <section>       
                                            <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="fecha1" class="col-sm-2 text-right control-label col-form-label">INGRESE DNI DEL CONTACTO:</label>
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="dnicontac" name="dnicontac">
                                                                                                
                                                </div>
                                            
                                            <div class="col-sm-offset-3 col-sm-7">  
                                                 
                                                <a class="btn btn-danger" href="#"><i class="mdi mdi-close"></i>Cancelar                                                                      
                                                </a>  
                                            <a class="btn btn-success" href="#" onclick="Buscarcontac()"><i class="mdi mdi-magnify"></i>Buscar                                                              
                                            </a>     
