...
<head>
    ...
    <title>CONSULTA ENTRE FECHAS</title>
    <!-- Custom CSS -->
                    ...
                    <body>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h3 class="card text-center">LISTA DE VALORIZACIONES POR FECHA</h3>
                                            <section>       
                                            <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label for="fecha1" class="col-sm-2 text-right control-label col-form-label">FECHA INICIO:</label>
                                                <div class="col-sm-3">
                                                    <input type="date" class="form-control" id="fecha1" name="fecha1">
                                                </div>
                                                <label for="fecha2" class="col-sm-2 text-right control-label col-form-label">FECHA FIN:</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-offset-3 col-sm-7">        
                                                ...
                                                <a class="btn btn-success" href="#" onclick="Buscarval()"><i class="mdi mdi-magnify"></i>Buscar                                                              
                                                </a>
                                            </div>
                                            </div>                                                                     
